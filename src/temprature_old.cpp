...
// WiFi credentials
const char *ssid = lib_private.getWifiSSID();
const char *password = lib_private.getWifiPassword();
...
void loop() {
	...
	if (WiFi.status() == WL_CONNECTED) {
		...
		String urlFinal =
			"https://script.google.com/macros/s/" + GOOGLE_SCRIPT_ID + "/exec?" + "date=" + (String)date_time + "&sensor=" + (String)LM35_TempC_Sensor1;
